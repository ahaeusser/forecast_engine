...
input_file <- "data/M4_daily_42_10_data.rds"
...
run_name <- "M4_daily_42_10"    # set a name for the run
...
n_ahead <- 14                   # size for testing window (forecast horizon)
